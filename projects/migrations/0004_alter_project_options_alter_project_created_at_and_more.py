# Generated by Django 5.2.4 on 2026-05-06 20:15
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='project',
            name='github_url',
            field=models.URLField(blank=True, validators=[django.core.validators.RegexValidator('^https?://github\\.com/', 'Ссылка должна вести на GitHub')], verbose_name='GitHub ссылка'),
        ),
        migrations.AlterField(
            model_name='project',
            name='name',
